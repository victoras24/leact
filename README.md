...
Created the html file, added the necessary tags. Like <html>, <head>, <body>, <sript>. And now? We have to somehow start scripting I guess. So I new the way to do that just started with an easy console log in the script tags. Now we need to render a component on the page. So I did the below
